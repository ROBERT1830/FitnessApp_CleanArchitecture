...
fun NutrientBarInfo(
    ...
    /**
     * We will have a box and inside a canvas to drae the circle
     * and in the center of the box the text
     */
    Box(modifier = modifier, contentAlignment = Alignment.Center) {
        ...
        Column(
            ...
            UnitDisplay(
                ...
                //if we dont exceed the goal
                amountColor = if (value <= goal){
                    MaterialTheme.colors.onPrimary //text white
                }else goalExceededColor, // text red
